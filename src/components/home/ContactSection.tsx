    ...
    <section id="Contact" className="py-12 md:py-20 px-4">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="flex flex-col md:flex-row items-center md:justify-center gap-4 mb-8"
        >
          <a
            href="mailto:ken.yeck@gmail.com"
            className="group flex items-center gap-2 px-6 py-3 rounded-full 
            bg-gray-800/20 dark:bg-gray-800/50 hover:bg-gray-800/30 dark:hover:bg-gray-800 transition-colors size-fit"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
